...
public class PlayerActions extends ActionsManager{
    ...
    public void enter() {
        ...
        if (this.accessiblePlaces.contains(Game.GameData.map.get(Game.GameData.firstIndex).get(1).getType())){
            if (person.getPlace() != null)
                leave();
            this.person.getActions().addActions(person.getPlace().getActions().getActions());
        } else{
    ...
    public void leave() {
         ...
         */
        person.getActions().removeActions(person.getPlace().getActions().getActions());
    ...
    private Object getChunk(){
        //return this.person.getPlace().getElements()[Game.GameData.firstIndex]
        return new Object();
    } 
}
